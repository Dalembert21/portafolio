...
export default function Projects({ lang }) {
  ...
  id: 2,
  title: {
    en: "Credit Simulation System",
    es: "Sistema de simulación de créditos"
  },
  tools: [
    "React",
    "NestJS",
  ...
  desc: {
    en: "Credit simulation platform for Ecuadorian banks with biometric identity validation, customizable configurations per institution, advisor management, and responsive dashboard interface.",
    es: "Plataforma de simulación de créditos para bancos del Ecuador con validación biométrica de identidad, configuraciones personalizables por institución, gestión de asesores y panel administrativo responsive."
  },
  image: financieroImage,
  link: "https://sistemafinancierodb.netlify.app/dashboard",
  features: {
    en: [
      "Credit simulation system",
      "Biometric identity validation",
      "Ecuadorian ID recognition",
      "Facial scan verification",
      "Anti-impersonation security",
      "Super admin panel",
      "Bank advisor management",
    ...
    es: [
      ...
      "Reconocimiento de cédula ecuatoriana",
      "Verificación mediante escaneo facial",
      "Seguridad anti suplantación",
      "Panel de super administrador",
      "Gestión de asesores bancarios",
      "Configuraciones personalizadas por banco",
      "Dashboard responsive",
      "Autenticación con Supabase",
      "API REST con NestJS"
    ]
  },
  github: "https://github.com/Dalembert21/sistemaAmortizacionFrontend"

    },
    {
      id: 3,
      title: {
        en: "Lion Producciones",
        es: "Lion Producciones"
      },
